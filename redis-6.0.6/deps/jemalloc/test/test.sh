...
for t in $@; do
  ...
  if [ -e "${t}.sh" ] ; then
    ...
    . ${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/bs/Desktop/flask/flask-boilerplate-prod/redis-6.0.6/deps/jemalloc/ /home/bs/Desktop/flask/flask-boilerplate-prod/redis-6.0.6/deps/jemalloc/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/bs/Desktop/flask/flask-boilerplate-prod/redis-6.0.6/deps/jemalloc/ /home/bs/Desktop/flask/flask-boilerplate-prod/redis-6.0.6/deps/jemalloc/
